            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                    ...
                    $id=htmlspecialchars($_GET['id']);
										...
										{	
                                            ?>
												<a href="#"><img alt="" src="employees/<?php echo htmlentities($row->Picture);?>"></a>
											</div>
										</div>
											...
											<div class="row">
												<div class="col-md-5">
													<div class="profile-info-left">
														<h3 class="user-name m-t-0 mb-0"><?php echo htmlentities($row->FirstName) ;?></h3>
												...
												<div class="col-md-7">
													<ul class="personal-info">
														<li>
															...
															<div class="text"><a href=""><?php echo htmlentities($row->Phone) ;?></a></div>
														</li>
														<li>
															<div class="title">Email:</div>
															<div class="text"><a href=""><?php echo htmlentities($row->Email) ;?></a></div>
														</li>
														<li>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="profile-img-wrap edit-img">
												<img class="inline-block" src="employees/<?php echo htmlentities($row->Picture); ?>" alt="user">
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" value="<?php echo htmlentities($row->FirstName) ;?>">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label>Last Name</label>
														<input type="text" class="form-control" value="<?php echo htmlentities($row->LastName) ;?>">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
